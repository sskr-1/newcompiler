...
function_definition:
    declaration_specifiers declarator compound_statement {
        auto func_decl = new FunctionDeclaration("", nullptr);
        // TODO: Extract function name and type from declarator
        func_decl->body = std::unique_ptr<Block>($3);
        $$ = func_decl;
    }
    ;
...
declaration:
    declaration_specifiers declarator SEMICOLON {
        auto var_decl = new VariableDeclaration("", nullptr);
        // TODO: Extract variable name and type from declarator
        $$ = var_decl;
    }
    | declaration_specifiers declarator ASSIGN assignment_expression SEMICOLON {
        auto var_decl = new VariableDeclaration("", nullptr, std::unique_ptr<Expression>($4));
        // TODO: Extract variable name and type from declarator
        $$ = var_decl;
    }
...
declaration_specifiers:
    ...
    | storage_class_specifier type_specifier { $$ = $2; }
    | type_specifier storage_class_specifier { $$ = $1; }
    ;
...
declarator:
    ...
    | pointer direct_declarator {
        // TODO: Combine pointer with declarator
        $$ = $1;
    }
    ;
...
direct_declarator:
    IDENTIFIER {
        // TODO: Create proper declarator representation
        $$ = new Type(Type::INT_TYPE);
        free($1);
    }
...
pointer:
    MULT {
        // TODO: Create pointer type
        $$ = new Type(Type::POINTER_TYPE);
    }
    | MULT pointer {
        // TODO: Create pointer to pointer
        $$ = $2;
    }
    ;
...
typedef_declaration:
    TYPEDEF declaration_specifiers declarator SEMICOLON {
        auto typedef_decl = new TypedefDeclaration("", std::unique_ptr<Type>($2));
        $$ = typedef_decl;
    }
    ;
